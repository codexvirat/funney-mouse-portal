...
export function exportCSV(bills, tag) {
  const head = ['Date', 'Bill No', 'Time', 'Customer', 'Phone', 'Category', 'Item', 'Qty', 'Rate', 'Amount', 'Bill Total', 'CGST', 'SGST', 'Advance', 'UPI', 'Cash', 'Card', 'Due', 'Status'];
  ...
  sorted.forEach(b => b.items.forEach((i, ix) => lines.push([
    ...
    i.rate, i.amount, ix === 0 ? b.total : '', ix === 0 ? (b.cgst || 0) : '', ix === 0 ? (b.sgst || 0) : '',
    ix === 0 ? (b.advance || 0) : '', ix === 0 ? (b.pay.UPI || 0) : '', ix === 0 ? (b.pay.CASH || 0) : '',
